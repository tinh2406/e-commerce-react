...
interface DeleteCrawlerProps {
  crawlerId: string | undefined;
  setCrawlerId: (crawlerId: string | undefined) => void;
}

const DeleteCrawler = ({ crawlerId, setCrawlerId }: DeleteCrawlerProps) => {
  const crawlerStore = useCrawler();

  const handleDeleteCrawler = async () => {
    if (crawlerId) {
      await crawlerStore.delete(crawlerId);
  ...
  return (
    <>
      <div
        id="drawer-delete-crawler-default"
        className={twMerge([
      ...
      >
        ...
        <button
          ...
          data-drawer-dismiss="drawer-delete-crawler-default"
        ...
        <button
          ...
          data-drawer-hide="drawer-delete-crawler-default"
        >
          No, cancel
        </button>
      </div>
