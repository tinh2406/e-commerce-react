...
interface ProductMapperSelectProps {
...
const ProductMapperSelect = ({
  value,
  setValue,
  disabled,
}: ProductMapperSelectProps) => {
  ...
  return (
    ...
    >
      ...
      >
        {value
          ? productMapperStore.data.find(
              (productMapper) => productMapper.id === value
            )?.name
      ...
      >
        ...
        >
          ...
          <InfiniteScroll store={productMapperStore} />
        </div>
      </div>
      {value && (
        <button
...
export default ProductMapperSelect;
