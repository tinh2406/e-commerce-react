...
const UpdateCategory = ({ categoryId, setCategoryId }: UpdateCategoryProps) => {
  ...
  const handleUpdateCategory = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (category.name && categoryId) {
      await categoryStore.update(categoryId, category);
  ...
  return (
    <>
      ...
      transition-transform bg-white dark:bg-gray-800`,
          categoryId ? "translate-x-0" : "translate-x-full",
        ])}
        tabIndex={-1}
            ...
            <div className="gap-4 grid grid-cols-1">
              ...
              <div>
                ...
                <CategorySelect
                  ...
                  setValue={(value) => {
                    setCategory({ ...category, parent_id: value || undefined });
                  }}
                />
              </div>
